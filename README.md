...
```
python PIDE/classification.py [-o OUTPUT] [-g GPU] [-b BATCHSIZE] [-n MIXPNUM] [-d DISTANCE] [-s PISCORE] [-m] input model
```
...
optional arguments:
  ...
  -n MIXPNUM, --MixPNum MIXPNUM
                        The mix prophage ORF number of a PI (default is 5)
...
1. ###### cluster.csv
   ...
   **B**: The locations of the PI-carried cargo genes.
