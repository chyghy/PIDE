...
parser.add_argument('-n', '--MixPNum', type=int, default=5, help="The mix prophage ORF number of a PI")
...
for i in range(num):
    ...
    cluster_start(f'{output}/{i}.bed', f'{output}/{i}.cluster', args.MixPNum, args.Distance, args.PIScore)
